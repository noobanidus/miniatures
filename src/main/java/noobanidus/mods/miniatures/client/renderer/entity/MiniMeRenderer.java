...
public class MiniMeRenderer extends HumanoidMobRenderer<MiniMeEntity, MiniMeModel<MiniMeEntity>> {
  ...
  public MiniMeRenderer(EntityRenderDispatcher renderManager, MiniMeModel model, float shadow) {
  ...
  @Override
  protected void setupRotations(MiniMeEntity entityLiving, PoseStack matrixStackIn, float pAgeInTicks, float pRotationYaw, float pPartialTicks) {
  ...
  public static class Factory implements IRenderFactory<MiniMeEntity> {
    @Override
    @Nonnull
    public MiniMeRenderer createRenderFor(@Nonnull EntityRenderDispatcher manager) {
