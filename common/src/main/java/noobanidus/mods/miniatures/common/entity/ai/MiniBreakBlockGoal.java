...
public class MiniBreakBlockGoal extends MoveToBlockGoal {
  ...
  public boolean canContinueToUse() {
    return !MiniaturesAPI.getBreaksBlocks() && (MiniaturesAPI.getDistractionValue() != 0 && this.mob.getRandom().nextDouble() > MiniaturesAPI.getDistractionValue()) && super.canContinueToUse();
  }
  ...
  protected int nextStartTick(PathfinderMob pCreature) {
    return MiniaturesAPI.getBaseRunDelay() + pCreature.getRandom().nextInt(MiniaturesAPI.getRandomRunDelay());
  }
}
