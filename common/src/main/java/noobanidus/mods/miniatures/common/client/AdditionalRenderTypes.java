...
public class AdditionalRenderTypes extends RenderType {
  ...
  private static Function<ResourceLocation, RenderType> GLOWING = Util.memoize((pLocation) -> create("spirit_entity", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.QUADS, 256, false, true, CompositeState.builder()
